			...
			<div class="container">
				<table>
					<thead>
						<tr>
							<th
								style="width: 10%; background-color: #aaa; text-align: center; font-size: 18px;">문서번호</th>
							<th
								style="width: 60%; background-color: #aaa; text-align: center; font-size: 18px;">제목</th>
							<th
								style="width: 15%; background-color: #aaa; text-align: center; font-size: 18px;">작성자</th>
							<th
								style="width: 15%; background-color: #aaa; text-align: center; font-size: 18px;">작성일</th>
						</tr>
					</thead>
					<tbody>
						<%
